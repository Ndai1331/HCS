...
namespace HC.Migrations
{
    ...
    [Migration("20260602012203_Added_DocumentFile_DocxPdfPair")]
    partial class Added_DocumentFile_DocxPdfPair
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HC.DocumentAssignments.DocumentAssignment", b =>
                {
                    ...
                    b.HasIndex("ReceiverUserId", "Status", "WorkflowStepTemplateId")
            ...
            modelBuilder.Entity("HC.DocumentFiles.DocumentFile", b =>
                {
                    ...
                    b.HasIndex("DocumentId", "UploadedAt")
            ...
            modelBuilder.Entity("HC.DocumentWorkflowInstances.DocumentWorkflowInstance", b =>
                {
                    ...
                    b.Property<int>("TotalExtensionBusinessDays")
                        .HasColumnType("integer")
                        .HasColumnName("TotalExtensionBusinessDays");
            ...
            modelBuilder.Entity("HC.DocumentWorkflowInstances.DocumentWorkflowInstanceExtension", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ExtensionBusinessDays")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("NewFinishedAt")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.Property<DateTime>("PreviousFinishedAt")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.ToTable("AppDocumentWorkflowInstanceExtensions", (string)null);
                });
            ...
            modelBuilder.Entity("HC.Documents.DocumentBackgroundOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppDocumentBackgroundOperations", (string)null);
                });
            ...
            modelBuilder.Entity("HC.Notifications.NotificationOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProcessedTime", "CreationTime");

                    b.ToTable("AppNotificationOutboxes", (string)null);
                });
            ...
            modelBuilder.Entity("HC.SignatureSettings.SignatureSetting", b =>
                {
                    ...
                    b.Property<string>("LayoutImg")
                        .HasColumnType("text")
                        .HasColumnName("LayoutImg");
            ...
            modelBuilder.Entity("HC.SurveyFiles.SurveyFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("UploaderType")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("UploaderType");

                    b.HasKey("Id");

                    b.HasIndex("SurveySessionId");

                    b.ToTable("AppSurveyFiles", (string)null);
                });
            ...
            modelBuilder.Entity("HC.SurveyResults.SurveyResult", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("SurveyCriteriaId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SurveyCriteriaId");

                    b.HasIndex("SurveySessionId");

                    b.ToTable("AppSurveyResults", (string)null);
                });
            ...
            modelBuilder.Entity("HC.UserDepartments.UserDepartment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("HC.UserSignatures.UserSignature", b =>
                {
                    ...
                    b.Property<string>("SealImg")
                        .HasColumnType("text")
                        .HasColumnName("SealImg");
            ...
            modelBuilder.Entity("HC.Chat.Messages.Message", b =>
                {
                    b.HasOne("HC.Chat.Messages.Message", "ForwardedFromMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("HC.SurveyFiles.SurveyFile", b =>
                {
                    b.HasOne("HC.SurveySessions.SurveySession", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HC.SurveyResults.SurveyResult", b =>
                {
                    b.HasOne("HC.SurveyCriterias.SurveyCriteria", null)
                        .WithMany()
                        .HasForeignKey("SurveyCriteriaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
