...
public class DocumentAssignmentsAppService : DocumentAssignmentsAppServiceBase, IDocumentAssignmentsAppService
{
    ...
    public DocumentAssignmentsAppService(IDocumentAssignmentRepository documentAssignmentRepository, 
    ...
    IRepository<HC.WorkflowStepTemplates.WorkflowStepTemplate, Guid> workflowStepTemplateRepository,
     ...
     base(documentAssignmentRepository, documentAssignmentManager, downloadTokenCache, 
     documentRepository, workflowStepTemplateRepository, identityUserRepository)
    {
    ...
    public override async Task DeleteAsync(Guid id)
    {
        ...
        var assignmentWithNav = await _documentAssignmentRepository.GetWithNavigationPropertiesAsync(id);
    ...
    public override async Task<DocumentAssignmentDto> UpdateAsync(Guid id, DocumentAssignmentUpdateDto input)
    {
