...
public class HCMenuContributor : IMenuContributor
{
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(new ApplicationMenuItem("Documents", l["Menu:Documents"], icon: "fa fa-book", order: 2).AddItem(new ApplicationMenuItem("Documents.List", l["Menu:DocumentList"], icon: "bi bi-menu-button-wide-fill", url: "/manage-documents").RequirePermissions(HCPermissions.Documents.Default)).AddItem(new ApplicationMenuItem("Documents.MyDocuments", l["Menu:MyDocuments"], icon: "bi bi-menu-button-wide-fill", url: "/document-assignments").RequirePermissions(new string[] { HCPermissions.Documents.Default, HCPermissions.DocumentAssignments.Default })));
