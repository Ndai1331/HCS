...
- Ví dụ local API host theo AGENTS: `https://hanhchinhso.benhvien199.vn`.
- Mobile chỉ cần ghép: `{baseUrl}` + `{route}`.

Ví dụ:
- `GET https://hanhchinhso.benhvien199.vn/api/app/projects`
- `GET https://hanhchinhso.benhvien199.vn/api/app/project-tasks`
